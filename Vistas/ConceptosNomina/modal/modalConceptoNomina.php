<div div class="modal fade " id="modalEdiConceptos" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id=""><strong>Actualizar Conceptos de Nomina.</strong></h5>
            </div>
                        ...
                        <form name="" method="" action="" id="">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="">
                                        <select id="cmbTipoConceptoEdi" name="cmbTipoConceptoEdi" class="form-control input-sm "></select>
                                    </div>
                                </div>
