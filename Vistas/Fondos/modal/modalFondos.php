<div class="modal fade " id="mdlFondosPensiones" role="dialog" aria-labelledby="" aria-hidden="true">
...
<!--Modal Fondos Eps-->
<div class="modal fade " id="mdlFondosEps" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="col-md-12">
                        ...
                        <div id="divVisualizarFondo" style="overflow: auto; width: 100%; height:350px" class="">
                            <table id='tbl_visualizar_fondo' style='font-size: 11px;' class='table-condensed table-bordered  table table-bordered callback1 table-hover'>
                                ...
                                <tbody id="tboBodyFondoEps" style="cursor: pointer"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
